...
$nitropack_functions_file = '/home/customer/www/grupoterramarla.com/public_html/wp-content/plugins/nitropack/functions.php';
$nitropack_abspath = '/home/customer/www/grupoterramarla.com/public_html/';
...
if (file_exists($nitropack_functions_file) && ABSPATH == $nitropack_abspath) {
    ...
    define( 'NITROPACK_LOGGED_IN_COOKIE', 'wordpress_logged_in_20b0f2290fbcd021d37251a8673b2c3d' );
